...
import static com.example.payment.web.rest.TestUtil.createUpdateProxyForBean;
import static com.example.payment.web.rest.TestUtil.sameNumber;
...
import com.example.payment.IntegrationTest;
...
class PaymentResourceIT {
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentStatus(UPDATED_PAYMENT_STATUS).amount(UPDATED_AMOUNT);
