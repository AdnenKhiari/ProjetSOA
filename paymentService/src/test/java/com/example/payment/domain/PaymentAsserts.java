...
import static com.example.payment.domain.AssertUtils.bigDecimalCompareTo;
...
public class PaymentAsserts {
    ...
    public static void assertPaymentUpdatableFieldsEquals(Payment expected, Payment actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getProcessedAt()).as("check processedAt").isEqualTo(actual.getProcessedAt()));
    }
